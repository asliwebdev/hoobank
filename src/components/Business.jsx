...
const FeatureCard = ({index, icon, title, content}) => (
  <div className={`flex flex-row p-6 rounded-[20px] ${index === features.length - 1 ? 'mb-0' : 'mb-6'} feature-card`}>
    ...
    <div className="flex-1 flex flex-col ml-3">
       <h4 className="text-white font-poppins text-[18px] font-semibold leading-[23px] mb-1">
        {title}
       </h4>
       <p className="text-dimWhite font-poppins text-[16px] font-normal leading-[24px] mb-1">
        {content}
       </p>
    </div>
  </div>
